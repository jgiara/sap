...
echo '<input type="hidden" id="programName" value="User Involvement">';
?>
...
<head>
    ...
    <title>User Involvement - Student Admission Program - Boston College</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="overflow-x: auto;">
            <div class="row" style="maring-bottom: 0;">
                <div class="col-lg-12">
                    <h3 style="margin-top: 60px; margin-bottom: 0;" class="page-header" id="panels-header"><span id="nameSpan"></span>'s Involvement</h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
    ...
    $(document).ready(function() {
        ...
        getName(function(item) {
            document.getElementById("nameSpan").innerHTML = item[0] + " " + item[1];
        }, email);
